...
{ 
    ...
    ___self="$0";
    ___self_PID="$$";
    ___MAIN_FUNCNAME="main@bashbox%15062";
            ...
            { 
                ...
                { 
                    ...
                    if test ! -e "$tmux_init_lock"; then
                        { 
                            "$HOME/.dotfiles/src/utils/vimpod.py" & ( gp ports await 23000 > /dev/null && gp ports await 29000 && gp preview "$(gp url 29000)" --external && { 
